...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/20230830-wrj-hh-5s/weights/best.pt', help='model path(s)')
    ...
    parser.add_argument('--name', default='test-5s', help='save results to project/name')
